package Game.Entity.GameEntity
{
   ...
   public class Ship extends GameEntity
   {
      ...
      private function updateOrbit(_dt:Number):void // 围绕天体旋转
      {
      ...
      private function updatePreJump1(_dt:Number):void // 制动飞船
      {
         image.rotation = 0;
      ...
      private function updatePreJump2(_dt:Number):void // 准备起飞
      {
      ...
      private function updateJump(_dt:Number):void // 飞行状态下的更新
      {
         var _x1:Number = NaN;
         var _y1:Number = NaN;
         var _dx:Number = NaN;
      ...
      private function updateFollow(_dt:Number):void // 跟随飞船
      {
         if (trail.alpha < 1)
            trail.alpha += _dt * 2;
         var _dx:Number = NaN;
      ...
      public function moveTo(_Node:Node, capture:Boolean = false):void // 移动至参数_Node指定天体
      {
         var _dtime:Number = NaN;
         var _dAngle:Number = NaN;
         var _x2:Number = NaN;
