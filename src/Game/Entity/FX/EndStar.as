...
package Game.Entity.FX
{
   ...
   public class EndStar extends GameEntity
   {
      ...
      public function initStar(_EndScene:EndScene, _x:Number, _y:Number, _delay:Number):void
      {
         ...
         Globals.teamColors[1] == 0?
            image.blendMode =glare1.blendMode =glare2.blendMode =glare3.blendMode =glare4.blendMode ="normal":
            image.blendMode =glare1.blendMode =glare2.blendMode =glare3.blendMode =glare4.blendMode ="add";
